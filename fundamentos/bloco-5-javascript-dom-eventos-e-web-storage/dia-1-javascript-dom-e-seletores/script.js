document.querySelector("#container").style.backgroundColor = "rgb(240, 240, 240)"
document.querySelector("#header-container").style.backgroundColor = "green"
document.querySelector(".emergency-tasks").style.backgroundColor = "#FBBAC6"
...
document.querySelector("#footer-container").style.backgroundColor = "#014F2E"